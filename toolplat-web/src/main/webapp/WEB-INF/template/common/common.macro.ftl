	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click" ><a href="${request.contextPath}/riqi"><i class="fa fa-circle-o text-red"></i> <span>时间计算</span></a></li>
				<li class="nav-click" ><a href="${request.contextPath}/unixtime"><i class="fa fa-circle-o text-orange"></i> <span>时间戳转换</span></a></li>
				<li class="nav-click" ><a href="${request.contextPath}/cron"><i class="fa fa-circle-o text-yellow"></i> <span>cron表达式</span></a></li>
				
				<!--
                <li class="nav-click" ><a href="${request.contextPath}/jobclient"><i class="fa fa-circle-o text-green"></i> <span>编码转换</span></a></li>
				<li class="nav-click" ><a href="${request.contextPath}/joblog"><i class="fa fa-circle-o text-aqua"></i><span>Maven依赖</span></a></li>
				<li class="nav-click" ><a href="${request.contextPath}/crontab"><i class="fa fa-circle-o text-blue"></i><span>设置</span></a></li>
