package com.toolplat.deduct.controller;

import java.util.ArrayList;

import com.toolplat.common.model.PageResult;
import com.toolplat.deduct.common.web.util.JsonResult;
...
import com.toolplat.deduct.common.web.util.JqueryDataTable;
...
//		binder.registerCustomEditor(String.class, new StringEscapeEditor(true, false));
	...
	protected <T> JsonResult<T> success(String msg, T data) {
		JsonResult<T> result = new JsonResult<T>(true, msg, data);
	...
	protected <T> JsonResult<T> error(String msg) {
		JsonResult<T> result = new JsonResult<T>(false, msg,null);
	 ...
	 * @return
	 */
	public <T> JqueryDataTable<T>  dataTable(PageResult<T> page) {
