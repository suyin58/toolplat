package com.toolplat.deduct.domain.qry;
import java.math.BigDecimal;

import com.toolplat.common.model.PageParameter;
import com.toolplat.deduct.domain.enums.DeductStatus;

public class DeductCurQry implements PageParameter {
